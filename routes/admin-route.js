...
const {
  ...
  deleteAssignedAsset,
  getAssignedAssets,
  getAssignedAssetById,
  updateAssignedAsset,
} = require("../controllers/assignAsset.controller");
router.post(
  "/user",
  upload.fields([
...
// assign asset
router.post("/assign-asset", assignAsset); // Create Asset Assignment
router.get("/get_all_assign_asset", getAssignedAssets); // Create Asset Assignment
router.get("/get_all_assign_asset/:id", getAssignedAssetById); // Create Asset Assignment
router.put("/update_assign_asset/:id", updateAssignedAsset); // Create Asset Assignment
router.delete("/assign-asset/:id", deleteAssignedAsset); // Create Asset Assignment
