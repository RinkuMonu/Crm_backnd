...
class aeronpay {
  ...
  transfer = async (req, res) => {
    try {
      ...
      const response = await axios.post(
        "https://superprodapi.aeronpay.in/api/core-services/serviceapi-prod/finance/securepay/v2/payout/imps_payment",
        data,
        {
          headers: headersData,
        },
  ...
  callBack = async (req, res) => {
    try {
      ...
      const data = req.body;
      const response = await axios.post(
        "https://server.finuniques.in/api/v1/aeronpay/callBack",
        data,
        {
          timeout: 10000,
          headers: {
  ...
  status = async (req, res) => {
    try {
      ...
      const { client_referenceId, mobile, date_of_transaction } = req.body;
